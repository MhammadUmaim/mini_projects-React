...
const Navbar = (props) => {
  return (
   ...
   {props && <div className="flex items-center gap-5"><img src="https://cdn-icons-png.flaticon.com/512/183/183411.png" className='sm:h-8 h-5' alt="" />{props.name}, {props.country}</div>}
   </nav>
  )
}
